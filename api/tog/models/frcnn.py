import sys
import os
sys.path.append(os.path.abspath('/Users/Doheon/Desktop/Doheon/documents/ml/TOG/frcnn_utils/pytorch-faster-rcnn/lib'))
sys.path.append(os.path.abspath('/Users/Doheon/Desktop/Doheon/documents/ml/TOG/frcnn_utils/pytorch-faster-rcnn/tools'))
